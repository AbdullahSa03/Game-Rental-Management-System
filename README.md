...
- **SQL / MySQL / MariaDB**
- **PL/SQL or Stored Procedures** (if used)
- **DDL & DML Operations**
- **User Access Control**
- **Triggers / Functions** (if included)
- **Encryption Logic (Custom Caesar Cipher)**
...
# 🧾 Example Tables (Recommended Repo Structure)
